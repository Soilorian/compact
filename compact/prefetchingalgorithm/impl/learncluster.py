...
Requires:
 ...
 - Repository provides MemoryAccess dataclass in compact.prefetchingalgorithm.impl.types
"""
...
logger = logging.getLogger("compact.prefetchingalgorithm.impl.learncluster")
...
# -------------------------
from compact.prefetchingalgorithm.impl._shared import MRB, Scheduler
