...
python run.py --config compact/config/configs/sample_bestoffset.yml

# SMS - Spatial Memory Streaming
python run.py --config compact/config/configs/sample_sms.yml

# Bingo - Advanced spatial prefetcher
python run.py --config compact/config/configs/sample_bingo.yml
...
# Where to save logs
log_file: "compact/config/logs/my_run.log"
...
1. Copy a sample config:
   ```bash
   cp compact/config/configs/sample_linear.yml my_config.yml
   ```
...
```bash
# Linear
python run.py --config compact/config/configs/sample_linear.yml --log-file linear_result.log

# SMS
python run.py --config compact/config/configs/sample_sms.yml --log-file sms_result.log

# Bingo
python run.py --config compact/config/configs/sample_bingo.yml --log-file bingo_result.log
...
[2024-10-18 15:42:31] [INFO] compact.config.config_loader - Loading configuration from: compact/config/configs/sample_linear.yml
[2024-10-18 15:42:31] [INFO] compact.config.config_loader - Configuration loaded and validated successfully
[2024-10-18 15:42:31] [INFO] compact.config.config_loader - Loading algorithm: linear
[2024-10-18 15:42:31] [INFO] compact.config.config_loader - Successfully instantiated linear prefetcher
[2024-10-18 15:42:32] [INFO] compact.analyzer.analyzer - Analysis complete
[2024-10-18 15:42:32] [INFO] compact.analyzer.analyzer -   Correct predictions: 847
[2024-10-18 15:42:32] [INFO] compact.analyzer.analyzer -   Incorrect predictions: 153
[2024-10-18 15:42:32] [INFO] compact.analyzer.analyzer -   Accuracy: 84.70%
```
...
python run.py --config compact/config/configs/sample_linear.yml --log-file test_linear.log
python run.py --config compact/config/configs/sample_sms.yml --log-file test_sms.log
python run.py --config compact/config/configs/sample_bingo.yml --log-file test_bingo.log
